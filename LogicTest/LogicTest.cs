...
namespace UnitTestProject
{
    ...
    public class LogicTest
    {
        ...
        public class TestData : AbstractDataAPI
        {
            ...
            public override AbstractBallDataAPI spawnBalls(bool isSimulationRunning)
            {
        ...
        public void CreateBall_AddsNewBallToList()
        {
            ...
            Assert.IsNotNull(ballsApi.BallsList);
            Assert.AreEqual(1, ballsApi.GetNumberOfBalls());
        }
        ...
        public void Test_GetAllBalls()
        {
            ...
            List<AbstractBallDataAPI> balls = ballsApi.BallsList;
